const SUGGESTED = [
  { name: 'Steve Jobs', title: 'CEO of Apple', img: '/assets/images/people1.png', imgClass: '_info_img' },
  { name: 'Ryan Roslansky', title: 'CEO of Linkedin', img: '/assets/images/people2.png', imgClass: '_info_img1' },
  { name: 'Dylan Field', title: 'CEO of Figma', img: '/assets/images/people3.png', imgClass: '_info_img1' },
];
            ...
            <div className="_left_inner_area_suggest_info" key={p.name}>
              <div className="_left_inner_area_suggest_info_box">
                <div className="_left_inner_area_suggest_info_image">
                  <a href="#0">
                    <img src={p.img} alt={p.name} className={p.imgClass} />
                  </a>
                </div>
