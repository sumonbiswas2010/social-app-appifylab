  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
      <div className="container _custom_container">
        ...
        {/* NOTE: bootstrap's `collapse` class is omitted — Tailwind v4 also defines
            `.collapse { visibility: collapse }` which would hide the whole menu */}
            ...
            <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown${profileOpen ? ' show' : ''}`}>
              <div className="_nav_profile_dropdown_info">
                <div className="_nav_profile_dropdown_image">
                  <Avatar user={me} size="h-[54px] w-[54px]" />
                </div>
